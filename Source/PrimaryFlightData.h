...
private:
    ...
    Q_PROPERTY(
        int lateralNavigationMode READ lateralNavigationMode NOTIFY lateralNavigationModeChanged)
    Q_PROPERTY(
        int verticalNavigationMode READ verticalNavigationMode NOTIFY verticalNavigationModeChanged)
    Q_PROPERTY(int courseDeviationIndicatorMode READ courseDeviationIndicatorMode NOTIFY
                   courseDeviationIndicatorModeChanged)
    ...
    Q_PROPERTY(
        double rightTankFuel READ rightTankFuel WRITE setRightTankFuel NOTIFY rightTankFuelChanged)
    ...
    Q_PROPERTY(double engineTemperature READ engineTemperature WRITE setEngineTemperature NOTIFY
                   engineTemperatureChanged)
    Q_PROPERTY(double enginePressure READ enginePressure WRITE setEnginePressure NOTIFY
                   enginePressureChanged)
